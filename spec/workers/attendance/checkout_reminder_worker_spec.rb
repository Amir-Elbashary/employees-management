...
RSpec.describe Attendance::CheckoutReminderWorker, type: :worker do
  describe 'Testing worker' do
    ...
    it 'ensures job is queued in sidekiq' do
      described_class.perform_in(475.minutes.from_now, 'checkout_reminder', true)
      expect(described_class).to have_enqueued_sidekiq_job('checkout_reminder', true).in 475.minutes
    end
