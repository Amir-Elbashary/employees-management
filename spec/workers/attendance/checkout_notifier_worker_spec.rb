...
RSpec.describe Attendance::CheckoutNotifierWorker, type: :worker do
  describe 'Testing worker' do
    ...
    it 'ensures job is queued in sidekiq' do
      described_class.perform_async('checkout_notifier', true)
      expect(described_class).to have_enqueued_sidekiq_job('checkout_notifier', true)
    end
